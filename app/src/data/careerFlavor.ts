...
export const TIER_TITLE: Record<CareerTier, string> = {
  Silver: 'BFL Role Player',
  Gold: 'Established Starter',
  Diamond: 'League Star',
  Sapphire: 'League Icon',
  Rainbow: 'BFL Legend',
}

export const TIER_BADGE: Record<CareerTier, string> = {
  Silver: 'Silver Career',
  Gold: 'Gold Career',
  Diamond: 'Diamond Career',
  Sapphire: 'Sapphire Career',
  Rainbow: 'Rainbow Career',
}
...
const NICKNAMES: Record<Position, string[]> = {
  QB: ['the strategist', 'the golden arm', 'the field general', 'the fourth-quarter master'],
  WR: ['sure hands', 'the flash', 'the yard thief', 'the sideline magician'],
  'RB-FB': ['the hammer', 'the backfield ghost', 'the locomotive', 'the tackle breaker'],
  CB: ['the lockdown corner', 'the shadow', 'the ball hawk', 'the unbeatable wall'],
  SS: ['the guardian', 'the last wall', 'the defensive strategist', 'the last line of defense'],
  EDGE: ['the hunter', 'the storm', 'tackles\' worst nightmare', 'the sack specialist'],
}
